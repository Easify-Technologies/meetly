        ...
        <>
            ...
            <div className="hidden lg:block">
                <div className="grid grid-cols-2 lg:grid-cols-[1fr_auto_1fr] items-center min-h-0 lg:min-h-20 p-4 w-full">
                    <a className="flex items-center gap-2 w-20 active" href="#" data-status="active" aria-current="page">
                        <Image
                    ...
                    <div className="hidden lg:flex items-center gap-6">
                        ...
                        <Link data-slot="button" href="#" className="inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm md:text-base font-medium transition-all select-none disabled:pointer-events-none disabled:opacity-50 [&amp;_svg]:pointer-events-none [&amp;_svg:not([class*='size-'])]:size-4 shrink-0 [&amp;_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive underline-offset-4 hover:underline rounded-full has-[&gt;svg]:px-4 w-fit h-fit p-0">Settings</Link>
                    </div>
