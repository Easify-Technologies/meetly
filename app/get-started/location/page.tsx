                        ...
                        <div className="p-4">
                          <div className="flex justify-between items-start mb-4">
                            ...
                            <Link
                              href="/get-started"
                              type="button"
                              className="inline-flex justify-center items-center text-sm md:text-base whitespace-nowrap font-medium transition-all text-[#2F1107] bg-[#FFD100] rounded-full cursor-pointer px-3 py-2 hover:bg-[#2F1107] hover:text-[#ffd100] duration-500"
                            >
                              Change
                            </Link>
                          </div>
